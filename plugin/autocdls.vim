...
command! -nargs=? -bar -bang -complete=dir Ls call autocdls#get_list(<q-args>, <q-bang>, '')
command! -nargs=? -bar -bang -complete=dir LsGrep call autocdls#ls_grep(<q-args>, <q-bang>)
